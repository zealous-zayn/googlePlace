...
module.exports.setRouter = (app) =>{
    ...
    */
    ...
    app.get(`${baseUrl}/update-location`, auth.isAuthorized, userController.updateCurrentLocation)
    /**
     * @apiGroup users
     * @apiVersion  1.0.0
     * @api {post} /api/v1/users/update-location api to Update current location.
     *
     * @apiParam {string} userId userId of the user. (query params) (required)
     * @apiParam {string} currentLocation Longitude and lattitude of the current location of the user. (query params) (required)
     * @apiParam {string} authToken authToken of the user. (query/body/header params) (required)
     * @apiSuccess {object} myResponse shows error status, message, http status code, result.
     * 
     * @apiSuccessExample {object} Success-Response:
